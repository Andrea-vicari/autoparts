...
function ListaComponenti() {
  ...
  const [componentiEXP, setComponenti] = useState([]);
  ...
  const currentPosts = componentiEXP.slice(indexOfFirstPost, indexOfLastPost);
        ...
        <div className="container-fluid mt-2 pt-0">
          <div className='table-responsive-lg mt-2'>
            <table className={"table table-striped table-hover" + " " + tableType}>
              ...
              <tbody>
                <Lista componenti={componentiEXP} loading={loading} />
              </tbody>
              <Pagination length={componentiEXP.length} postsPerPage={postsPerPage} handlePagination={handlePagination} currentPage={currentPage} />
